...
/* harmony export */   "default": () => (/* binding */ FetchCheckIn)
/* harmony export */ });
...
async function FetchCheckIn(req, res) {
    ...
    if (session) {
        try {
            ...
            res.status(500).json({
                error: "Unable to fetch checkins..."
            });
        }
    } else {
        res.status(401).json({});
...
var __webpack_exports__ = __webpack_require__.X(0, [264], () => (__webpack_exec__(5158)));
