    ...
    <div className="hero relative -mt-16 flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        <div className="overflow-hidden rounded-full">
          <Image src="/images/avatar/profile.jpg" width={280} height={280} alt="avatar" />
        </div>
        <h1 className="mt-4 text-3xl font-bold ">Dylan Nguyen</h1>
        <div className="mt-2 flex gap-1">
          {' '}
          {' '}
          <Typed strings={['Welcome, I am Dylan...', 
            'A computer science student...',
            'A cyber-security intern...',
